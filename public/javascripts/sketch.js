...
const englishMsgs = {
  ...
  tryAgain: "This participant has finished all tasks. Start a new test session with the next child.",
  male: "Male",
  female: "Female",
  nonbinary: "Prefer not to answer",
  rabbitTaskButton: "Task 1",
  treeTaskButton: "Task 2",
  rainTaskButton: "Task 3"
}
